...
readonly SCRTH_PATH="/global/cscratch1/sd/${USER}/E3SMv2/"
# Machine and project
...
readonly CASE_NAME="v2.NARRM.historical_0151" #Modify for a new run
...
readonly RUN_REFDATE="0151-01-01"   # same as MODEL_START_DATE for 'branch', can be different for 'hybrid' #modify

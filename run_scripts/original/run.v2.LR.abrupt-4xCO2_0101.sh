...
readonly CHECKOUT="20210709"
readonly BRANCH="wlin/atm/v2pr_updates_qbo_co2" # PR 4385
readonly CHERRY=( )
...
readonly RUN_REFDIR="/lcrc/group/e3sm/ac.golaz/E3SMv2/v2.LR.abrupt-4xCO2_0101/init"

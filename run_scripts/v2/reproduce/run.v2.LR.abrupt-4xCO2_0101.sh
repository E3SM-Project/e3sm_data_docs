...
#
# Configured to reproduce v2.LR.abrupt-4xCO2_0101 on chrysalis.
...
#readonly CASE_NAME=${CHECKOUT}.abrupt-4xCO2_0101.${RESOLUTION}.${MACHINE}
# For production simulations:
readonly CASE_NAME="v2.LR.abrupt-4xCO2_0101"
...
readonly RUN_REFDIR="/lcrc/group/e3sm/${USER}/E3SMv2_test/v2.LR.abrupt-4xCO2_0101/init"

...
#
# Configured to reproduce v2.LR.hist-GHG_0301 on chrysalis.
...
#readonly CASE_NAME=${CHECKOUT}.hist-GHG_0301.${RESOLUTION}.${MACHINE}
# For production simulations:
readonly CASE_NAME="v2.LR.hist-GHG_0301"
...
readonly RUN_REFDIR="/lcrc/group/e3sm/${USER}/E3SMv2_test/v2.LR.hist-GHG_0301/init"

...
#
# Configured to reproduce v2.LR.piClim-histall_0021 on chrysalis.
...
#readonly CASE_NAME=${CHECKOUT}.piClim-histall_0021.${RESOLUTION}.${MACHINE}
# For production simulations:
readonly CASE_NAME="v2.LR.piClim-histall_0021"
...
readonly RUN_REFDIR="/lcrc/group/e3sm/${USER}/E3SMv2_test/v2.LR.piClim-histall_0021/init"

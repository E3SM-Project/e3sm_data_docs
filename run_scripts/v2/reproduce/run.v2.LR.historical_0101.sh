...
#
# Configured to reproduce v2.LR.historical_0101 on chrysalis.
...
#readonly CASE_NAME=${CHECKOUT}.historical_0101.${RESOLUTION}.${MACHINE}
...
readonly RUN_REFDIR="/lcrc/group/e3sm/${USER}/E3SMv2_test/v2.LR.historical_0101/init"
...
readonly OLD_EXECUTABLE="/lcrc/group/e3sm/ac.forsyth2/E3SMv2/v2.LR.piControl/build/e3sm.exe"

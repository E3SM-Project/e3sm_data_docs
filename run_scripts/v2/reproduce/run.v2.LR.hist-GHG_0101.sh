...
#
# Configured to reproduce v2.LR.hist-GHG_0101 on chrysalis.
...
#readonly CASE_NAME=${CHECKOUT}.hist-GHG_0101.${RESOLUTION}.${MACHINE}
...
readonly RUN_REFDIR="/lcrc/group/e3sm/${USER}/E3SMv2_test/v2.LR.hist-GHG_0101/init"

...
#
# Configured to reproduce v2.LR.piClim-histaer_0031 on chrysalis.
...
#readonly CASE_NAME=${CHECKOUT}.piClim-histaer_0031.${RESOLUTION}.${MACHINE}
# For production simulations:
readonly CASE_NAME="v2.LR.piClim-histaer_0031"
...
readonly RUN_REFDIR="/lcrc/group/e3sm/${USER}/E3SMv2_test/v2.LR.piClim-histaer_0031/init"
readonly RUN_REFCASE="v2.LR.piClim-control"
readonly RUN_REFDATE="0031-01-01"   # same as MODEL_START_DATE for 'branch', can be different for 'hybrid'

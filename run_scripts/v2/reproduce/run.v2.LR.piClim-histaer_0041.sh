...
#
# Configured to reproduce v2.LR.piClim-histaer_0041 on chrysalis.
...
#readonly CASE_NAME=${CHECKOUT}.piClim-histaer_0041.${RESOLUTION}.${MACHINE}
# For production simulations:
readonly CASE_NAME="v2.LR.piClim-histaer_0041"
...
readonly RUN_REFDIR="/lcrc/group/e3sm/${USER}/E3SMv2_test/v2.LR.piClim-histaer_0041/init"

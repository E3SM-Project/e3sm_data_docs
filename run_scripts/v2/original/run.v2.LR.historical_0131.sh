...
readonly CASE_NAME="v2.LR.historical_0131"
...
readonly RUN_REFDIR="/global/cscratch1/sd/golaz/E3SMv2/v2.LR.historical_0131/init"
readonly RUN_REFCASE="v2.LR.piControl"
readonly RUN_REFDATE="0131-01-01"   # same as MODEL_START_DATE for 'branch', can be different for 'hybrid'

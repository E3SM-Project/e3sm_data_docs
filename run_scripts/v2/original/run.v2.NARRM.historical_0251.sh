...
readonly SCRTH_PATH="/global/cscratch1/sd/${USER}/E3SMv2" # do not add "/" at the end
# Machine and project
...
readonly CASE_NAME="v2.NARRM.historical_0251" #Modify for a new run
readonly CASE_GROUP="v2.RRM"

# Code and compilation
readonly CHECKOUT="20211217" #modify
readonly BRANCH="b5525f3239ad2df747f5eff113cf16ffa1f11584" # master as of 20211217 #modify
...
readonly RUN_REFDIR="${SCRTH_PATH}/${CASE_NAME}/init" #modify
readonly RUN_REFCASE="v2.NARRM.piControl"
readonly RUN_REFDATE="0251-01-01"   # same as MODEL_START_DATE for 'branch', can be different for 'hybrid' #modify

# Set paths
readonly CODE_ROOT="${HOME}/E3SMv2/${CHECKOUT}"
readonly CASE_ROOT="${SCRTH_PATH}/case_dirs/${CASE_NAME}"
...
#readonly run='XL_1x10_ndays'
#readonly run='XL2_1x5_ndays'
...
modify_pe_layout() {
    ...
    echo $'\n----- changing PE layout to XL2 -----\n'
    pushd ${CASE_SCRIPTS_DIR}

    ./xmlchange MAX_MPITASKS_PER_NODE=32
    ./xmlchange MAX_TASKS_PER_NODE=272
    ./xmlchange NTASKS_ATM=3680
    ./xmlchange NTASKS_CPL=3680
    ./xmlchange NTASKS_OCN=1440
    ./xmlchange NTASKS_WAV=1
    ./xmlchange NTASKS_GLC=1
    ./xmlchange NTASKS_ICE=3680
    ./xmlchange NTASKS_ROF=2656
    ...
    ./xmlchange ROOTPE_OCN=3680
    ./xmlchange ROOTPE_WAV=0
    ./xmlchange ROOTPE_GLC=0
    ./xmlchange ROOTPE_ICE=0
    ./xmlchange ROOTPE_ROF=1024

...
readonly CASE_NAME="v2.NARRM.historical_0101_bonus"
readonly CASE_GROUP="v2.RRM"

# Code and compilation
readonly CHECKOUT="20220615"
readonly BRANCH="6275091262780c7a4b54ba56dcfa013ab1efa149" # maint-2.0 as of 20220615
readonly CHERRY=( )
...
readonly RUN_REFDIR="/lcrc/group/e3sm/ac.qtang/E3SMv2/v2.NARRM.historical_0101/archive/rest/1979-01-01-00000"
readonly RUN_REFCASE="v2.NARRM.historical_0101"
readonly RUN_REFDATE="1979-01-01"   # same as MODEL_START_DATE for 'branch', can be different for 'hybrid'

...
readonly CASE_NAME="v2.NARRM.historical_0201" #Modify for a new run
...
readonly RUN_REFDATE="0201-01-01"   # same as MODEL_START_DATE for 'branch', can be different for 'hybrid' #modify

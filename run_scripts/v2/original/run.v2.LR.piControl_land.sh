...
readonly CASE_NAME="v2.LR.piControl_land"
readonly CASE_GROUP="v2.LR"

# Code and compilation
readonly CHECKOUT="20211022"
...
readonly START_DATE="0476-01-01"

# Additional options for 'branch' and 'hybrid'
readonly GET_REFCASE=TRUE
readonly RUN_REFDIR="/lcrc/group/e3sm/ac.golaz/E3SMv2/v2.LR.piControl/archive/rest/0476-01-01-00000"
readonly RUN_REFCASE="v2.LR.piControl"
readonly RUN_REFDATE="0476-01-01"   # same as MODEL_START_DATE for 'branch', can be different for 'hybrid'
...
# Turn on saving of land forcing data
cat << EOF >> user_nl_cpl
 histaux_a2x3hr = .true.
EOF

...
readonly RUN_REFDIR="/lcrc/group/e3sm/ac.xzheng/E3SMv2/v2.LR.hist-aer_0101/init"
...
readonly run='XS_2x5_ndays' # xs < 20 nodes => fits in debug queue. M80 uses 80 nodes, L uses 105.

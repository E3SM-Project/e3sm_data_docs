...
#
# Configured to reproduce v2.LR.hist-all-xGHG-xaer_0301 on chrysalis.
...
#readonly CASE_NAME=${CHECKOUT}.hist-all-xGHG-xaer_0301.${RESOLUTION}.${MACHINE}
# For production simulations:
readonly CASE_NAME="v2.LR.hist-all-xGHG-xaer_0301"
...
readonly RUN_REFDIR="/lcrc/group/e3sm/${USER}/E3SMv2_test/v2.LR.hist-all-xGHG-xaer_0301/init"
...
if [ "${run}" != "production" ]; then
  ...
  readonly STOP_N="15" # How often to stop the model, should be a multiple of REST_N
  readonly REST_OPTION="nyears"
  readonly REST_N="1"
  readonly RESUBMIT="10" # Submissions after initial one
  readonly DO_SHORT_TERM_ARCHIVING=false
fi

...
#
# Configured to reproduce v2.LR.hist-aer_0251 on chrysalis.
...
#readonly CASE_NAME=${CHECKOUT}.hist-aer_0251.${RESOLUTION}.${MACHINE}
...
readonly RUN_REFDIR="/lcrc/group/e3sm/${USER}/E3SMv2_test/v2.LR.hist-aer_0251/init"

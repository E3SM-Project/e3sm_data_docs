...
# CBGCv2-LNDATM SSP370 run script for anvil
# 
...
readonly COMPSET="SSP370_EAM%CMIP6_ELM%CNPRDCTCBC_MPASSI_DOCN%DOM_MOSART_SGLC_SWAV_BGC%LNDATM"
readonly RESOLUTION="ne30pg2_r05_EC30to60E2r2"
readonly CASE_NAME="v2.LR.BGC-LNDATM.SSP370.nofire"
readonly CASE_GROUP="v2.LR.BGC-LNDATM.SSP370.nofire"
...
readonly START_DATE="2085-01-01"

# Additional options for 'branch' and 'hybrid'
readonly GET_REFCASE=TRUE
# will need to change the following variables according to initial files
readonly RUN_REFCASE="v2.LR.BGC-LNDATM.SSP370" 
readonly RUN_REFDATE="2085-01-01"
readonly RUN_REFDIR="/lcrc/group/e3sm2/ac.sfeng1/E3SM_Simulations/20240404.v2.LR.BGC-LNDATM.SSP370.ne30pg2_r05_EC30to60E2r2.chrysalis/archive/rest/${RUN_REFDATE}-00000"
...
#readonly run='XL_12x2_nmonths' # XL jobs are not feasible for anvil; the XL layout is commented out
...
cat << EOF >> user_nl_eam
 ...
 co2flux_fuel_file = '/lcrc/group/e3sm/ac.sfeng1/E3SM_input/ssp370/append/ne30pg2_eam_CO2-em-anthro_input4MIPs_emissions_hist_ssp370_175001-21001_c20231108.nc'
 co2_readFlux_ocn = .true.
 co2flux_ocn_file = '/lcrc/group/e3sm/ac.sfeng1/E3SM_input/ssp370/append/ne30pg2_CSEM_hist_ssp370_ocean_flux_1850-2100_c20231108.nc'
 ...
 aircraft_datapath  =  '/lcrc/group/e3sm/ac.sfeng1/E3SM_input/ssp370/append'
...
cat << EOF >> user_nl_elm
  ...
  flanduse_timeseries = '/lcrc/group/e3sm/ac.sfeng1/test/pft/landuse.timeseries_0.5x0.5_rcp3.0_simyr2015-2100.nc'
  fsurdat = '/lcrc/group/e3sm/public_html//inputdata/lnd/clm2/surfdata_map/surfdata_0.5x0.5_simyr1850_c211019.nc'
...
runtime_options() {
    ...
    # reset the SST/Seaice data used 
    ./xmlchange SSTICE_DATA_FILENAME="/lcrc/group/e3sm/data/inputdata/ocn/docn7/SSTDATA/sst_ice_filled.v2.LR.SSP370_201.2015-2100.nc"
    ./xmlchange SSTICE_GRID_FILENAME="/lcrc/group/e3sm/data/inputdata/ocn/docn7/domain.ocn.0.5x0.5.c211007.nc"
    ./xmlchange --file env_run.xml --id SSTICE_YEAR_ALIGN --val 2015
    ./xmlchange --file env_run.xml --id SSTICE_YEAR_START --val 2015
    ./xmlchange --file env_run.xml --id SSTICE_YEAR_END --val 2100

...
readonly CASE_NAME="v2_1.LR.amip_0101"
# If this is part of a simulation campaign, ask your group lead about using a case_group label
readonly CASE_GROUP="v2_1.LR"

# Run options
readonly MODEL_START_TYPE="hybrid"  # 'initial', 'continue', 'branch', 'hybrid'
readonly START_DATE="1971-01-01"

# Additional options for 'branch' and 'hybrid'
readonly GET_REFCASE=TRUE
readonly RUN_REFDIR="/lcrc/group/e3sm/ac.golaz/E3SMv2_1/v2_1.LR.amip_0101/init"
readonly RUN_REFCASE="v2_1.LR.historical_0101"
readonly RUN_REFDATE="1971-01-01"   # same as MODEL_START_DATE for 'branch', can be different for 'hybrid'
...
if [ "${run}" != "production" ]; then
  ...
  readonly STOP_N="44" # How often to stop the model, should be a multiple of REST_N
